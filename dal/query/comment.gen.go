...
func (a commentBelongsToAuthor) Model(m *model.Comment) *commentBelongsToAuthorTx {
	return &commentBelongsToAuthorTx{a.db.Model(m).Association(a.Name())}
}

type commentBelongsToAuthorTx struct{ tx *gorm.Association }

func (a commentBelongsToAuthorTx) Find() (result *model.User, err error) {
	return result, a.tx.Find(&result)
}

func (a commentBelongsToAuthorTx) Append(values ...*model.User) (err error) {
...
func (a commentBelongsToAuthorTx) Replace(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a commentBelongsToAuthorTx) Delete(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
